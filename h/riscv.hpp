...
public:
    ...
    static ringBuffer* putcBuffer;
    static ringBuffer* getcBuffer;
    ...
    //read register mstatus
    static uint64 r_mstatus();

    // write register sstatus
    static void w_sstatus(uint64 sstatus);

    //supervisor_trap function
...
inline uint64 Riscv::r_mstatus()
{
    uint64 volatile mstatus;
    __asm__ volatile ("csrr %[mstatus], mstatus" : [mstatus] "=r"(mstatus));
    return mstatus;
}
